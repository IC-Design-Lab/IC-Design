...
1) Verilog Designs – Complete Verilog implementations for the experiments, laboratory exercises, and projects presented in the book.
2) Appendices A–C – Tutorials covering the recommended project directory structure, Vim Editor usage, Siemens ModelSim, AMD Vivado, and other essential commands and scripts for IC design projects.
3) Assignments and Projects – Carefully structured assignments and project-based learning materials to support hands-on education.
4) FPU Packages – Verilog IP modules including floating-point adders, multipliers, subtractors, and dividers. The IPs include:
High-speed versions based on deeply pipelined architectures across multiple clock cycles
Low-speed versions designed with single-clock-cycle latency
5) Book Materials – The cover page, preface, and table of contents.
6) Slides – Complete lecture slides for teaching related courses.
7) Training Materials – Structured design projects for selected lectures, supporting student training in EDA tools and simulation environment setup.
8) Additional Verilog Examples and Design Projects – Practical design examples and projects from the textbook.

These materials are intended to support project-based learning and to bridge the gap between academic instruction and industry-oriented IC design practice.
...
5) Examination tests to facilitate course assessment.
